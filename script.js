class Puzzle {
    ...
    timerButton() {
        ...
        this.timerButton.addEventListener('click', (event) => {
            (this.timerButton.innerHTML === 'СТАРТ') ? this.startTimer() : this.stopTimer();
    ...
    resultsButton() {
        ...
        this.resultsButton.addEventListener('click', (event) => {
            this.showResults()
        })
    ...
    moveElement() {
        ...
        let cellWidth = event.target.getBoundingClientRect().width + 3
    ...
    showWinWindow() {
        ...
        this.winApplyButton.addEventListener('click', (event) => {
            ...
            resultsArray.push({ name: this.inputName.value, turns: `Ходов: ${this.count}`, time: `Время: ${this.min}м. ${this.sec}с.`, sec: ((this.min * 60) + this.sec) });
            resultsArray.sort((elemA, elemB) => {
                return elemA.sec - elemB.sec;
            })
    ...
    showResults() {
        ...
        this.resultsCloseButton.addEventListener('click', (event) => {
